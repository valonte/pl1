...
The simplemap can be opened in GitHub Pages by modifying the url `https://valonte.github.io/pl1/services/simplemap.html`. Remember to replace the `[username]` portion with your actual GitHub username. 
